-- Drop table if it already exists (SQL Server 2016+)
...
🧠 Final Schema Overview (VERY IMPORTANT)
| Table             | Role                                     |
| ----------------- | ---------------------------------------- |
| `customer_orders` | What customers ordered (1 row = 1 pizza) |
| `runner_orders`   | Delivery outcome & runner info           |
| `runners`         | Runner registration                      |
| `pizza_names`     | Pizza dimension                          |
| `pizza_recipes`   | Standard toppings per pizza              |
| `pizza_toppings`  | Topping dimension                        |
